...
struct Instance {
    ...
    frame: u32,
    original_position: cgmath::Vector3<f32>,
}
        ...
        let instances = (0..NUM_INSTANCES_PER_ROW)
            .flat_map(|z| {
                (0..NUM_INSTANCES_PER_ROW).map(move |x| {
                    let z_normalized: f32 = z as f32 / NUM_INSTANCES_PER_ROW as f32;
                    let x_normalized: f32 = x as f32 / NUM_INSTANCES_PER_ROW as f32;
